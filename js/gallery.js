...
document.addEventListener(`keydown`, fooClose);

gallery.addEventListener(`click`, fooOpen);
function fooOpen(event) {
  if (event.target.classList.contains(`gallery-image`)) {
    const i = Array.from(allItems).indexOf(
